...
//import TrainBase_4178 from "../3DModels/TrainBase_4178";
//import TestBlock from "../3DModels/TestBlock/TestBlock";
// import {
//   CameraControls,
//   DragControls,
//   MapControls,
...
//const MODEL_SCALE = [0.01, 0.01, 0.01] as [number, number, number];
function App() {
  // const adjustScreenSizeAndPosition = () => {
  //   let modelScale = [0.01, 0.01, 0.01];
  //   const elementPosition = [0, 0, 3];
  ...
  //   }
  //   return [modelScale, screenPosition];
  // };
  return (
    <SceneSection>
      <StyledCanvas camera={{ near: 0.1, far: 1000, position: [0, 50, 100] }}>
...
export default App;
//<TrainBase_4178 position={[0, 0, 3]} scale={MODEL_SCALE} />
