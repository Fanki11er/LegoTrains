...
export const postCart4564Phase3: LegoBlockType[] = [
  {
    partPath: train_Buffer_Beam_4022,
    partStartPosition: new Vector3(20, 0, 520),
    partType: "4022",
  ...
  {
    partPath: train_Buffer_Beam_4022,
    partStartPosition: new Vector3(20, 0, 460),
    partType: "4022",
    materialId: "blackPlasticMaterial",
  ...
  },
  {
    ...
    partStartPosition: new Vector3(60, 0, 850),
    partType: "4023",
    materialId: "blackPlasticMaterial",
  ...
  {
    partPath: train_Coupling_4023,
    partStartPosition: new Vector3(60, 0, 875),
    partType: "4023",
    materialId: "blackPlasticMaterial",
  ...
  },
  {
    ...
    partStartPosition: new Vector3(85, 0, 850),
    partType: "73092",
  ...
  {
    partPath: magnet_Cylindrical_73092,
    partStartPosition: new Vector3(85, 0, 875),
    partType: "73092",
  ...
  },
  {
    ...
    partStartPosition: new Vector3(100, 0, 400),
    partType: "3020",
    materialId: "blackPlasticMaterial",
  ...
  {
    partPath: plate_2x4_3020,
    partStartPosition: new Vector3(100, 0, 425),
    partType: "3020",
    materialId: "blackPlasticMaterial",
  ...
  },
  {
    ...
    partStartPosition: new Vector3(435, 0, 390),
    partType: "3665",
    materialId: "blackPlasticMaterial",
  ...
  {
    partPath: slope_Brick_Inverted_3665,
    partStartPosition: new Vector3(435, 0, 415),
    partType: "3665",
    materialId: "blackPlasticMaterial",
  ...
  {
    partPath: slope_Brick_Inverted_3665,
    partStartPosition: new Vector3(435, 0, 440),
    partType: "3665",
    materialId: "blackPlasticMaterial",
  ...
  {
    partPath: slope_Brick_Inverted_3665,
    partStartPosition: new Vector3(435, 0, 465),
    partType: "3665",
    materialId: "blackPlasticMaterial",
