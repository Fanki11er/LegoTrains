...
import { platformCart4564ModelArrangementFunction } from "./platformCart4564ModelArrangementFunction";
...
export const set4564platformCartConfiguration: ModelConfiguration = {
  ...
  arrangementFunction: platformCart4564ModelArrangementFunction,
