...
export const moveInnerCraneBoomArmToPlace = (
  model: Object3D<Object3DEventMap>,
  distance: number,
  armMarkerId: string
) => {
  const innerCraneBoomArm = findElementConnectedToMarker(model, armMarkerId);
  innerCraneBoomArm.position.setX(innerCraneBoomArm.position.x + distance);
};
...
export const rotateCraneBoomHandle = (
  model: Object3D<Object3DEventMap>,
...
export const rotateCraneBlockadeHandle = (
  model: Object3D<Object3DEventMap>,
  markersIds: string[],
  angles: number[]
) => {
